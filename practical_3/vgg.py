...
def load_pretrained_VGG16_pool5(input, scope_name='vgg'):
    ...
    with tf.variable_scope(scope_name):
        ...
        with tf.name_scope('conv1_1') as scope:
            ...
            tf.histogram_summary("conv1_1/weights", kernel)
            tf.histogram_summary("conv1_1/bias", biases)
        ...
        with tf.name_scope('conv1_2') as scope:
            ...
            tf.histogram_summary("conv1_2/weights", kernel)
            tf.histogram_summary("conv1_2/bias", biases)
        ...
        with tf.name_scope('conv2_1') as scope:
            ...
            tf.histogram_summary("conv2_1/weights", kernel)
            tf.histogram_summary("conv2_1/bias", biases)
        ...
        with tf.name_scope('conv2_2') as scope:
            ...
            tf.histogram_summary("conv2_2/weights", kernel)
            tf.histogram_summary("conv2_2/bias", biases)
        # pool2
        ...
        with tf.name_scope('conv3_1') as scope:
            ...
            tf.histogram_summary("conv3_1/weights", kernel)
            tf.histogram_summary("conv3_1/bias", biases)
        ...
        with tf.name_scope('conv3_2') as scope:
            ...
            tf.histogram_summary("conv3_2/weights", kernel)
            tf.histogram_summary("conv3_2/bias", biases)
        ...
        with tf.name_scope('conv3_3') as scope:
            ...
            tf.histogram_summary("conv3_3/weights", kernel)
            tf.histogram_summary("conv3_3/bias", biases)
        ...
        with tf.name_scope('conv4_1') as scope:
            ...
            tf.histogram_summary("conv4_1/weights", kernel)
            tf.histogram_summary("conv4_1/bias", biases)
        ...
        with tf.name_scope('conv4_2') as scope:
            ...
            tf.histogram_summary("conv4_2/weights", kernel)
            tf.histogram_summary("conv4_2/bias", biases)
        ...
        with tf.name_scope('conv4_3') as scope:
            ...
            tf.histogram_summary("conv4_3/weights", kernel)
            tf.histogram_summary("conv4_3/bias", biases)
        ...
        with tf.name_scope('conv5_1') as scope:
            ...
            tf.histogram_summary("conv5_1/weights", kernel)
            tf.histogram_summary("conv5_1/bias", biases)
        ...
        with tf.name_scope('conv5_2') as scope:
            ...
            tf.histogram_summary("conv5_2/weights", kernel)
            tf.histogram_summary("conv5_2/bias", biases)
        ...
        with tf.name_scope('conv5_3') as scope:
            ...
            tf.histogram_summary("conv5_3/weights", kernel)
            tf.histogram_summary("conv5_3/bias", biases)
